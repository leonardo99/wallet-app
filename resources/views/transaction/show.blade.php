    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="space-y-3 bg-white overflow-hidden shadow-sm sm:rounded-lg py-6 flex flex-col items-center">
                ...
                <button class="p-2 bg-blue-100 hover:bg-blue-200 focus:bg-blue-200 active:bg-blue-200 text-sm text-blue-500 rounded-sm cursor-pointer flex items-center gap-1"><x-bi-arrow-down-circle /> Devolver valor</button>
            </div>
        </div>
    </div>
</x-app-layout>
